...
{{% notice warning %}}
Source hiện tại không gọi `DetectModerationLabels`. Không mô tả ảnh đã được kiểm duyệt hoặc bị Rekognition từ chối nếu chưa bổ sung service, policy và test tương ứng.
{{% /notice %}}
